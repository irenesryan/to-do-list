...
const SinglePage = () => {
    const aboutData = [
        ...
        },
        {
            ...
            description: "This app was developed by Irene Ryan, a self-taught web developer. She is opened to freelance Gig. So go ahead and connect with IRyan on Twitter @ireneryan."
        }
    ]
